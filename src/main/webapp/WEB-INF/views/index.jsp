...
<body>
	<div class="e46_245">
		...
		<c:if test="${sessionScope.member != null}">
			...
			<span class="e46_247">P L A N O U T</span>
		<div class="col">
			<div class="shownameinfo"><span style="color: blue;">${sessionScope.member.username}</span>님 반갑습니다.</div>
		</div>
		...
		<span class="designtext">DESIGN LIST </span>
		...
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="recommendimg1"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="recommendimg2"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="recommendimg3"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="recommendimg4"></div>
		
		<!-- 신상제품 -->
		<span class="newprodtext">NEW PRODUCTS</span>
		
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="newproductimg1"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="newproductimg2"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="newproductimg3"></div>
		<div OnClick ="location.href='${pageContext.request.contextPath}/product/cardlist'" class="newproductimg4"></div>
		...
		<!-- 푸터 목록 -->
		<span class="footertext">P L A N O U T</span>
